...
public class HelloServlet extends HttpServlet {
    ...
    String username = "Sharvari";
    String password = "EknathKalbandhe";
    String servers = "ac-vlwpqud-shard-00-00.nfihdq0.mongodb.net:27017," +
            "ac-vlwpqud-shard-00-01.nfihdq0.mongodb.net:27017," +
            "ac-vlwpqud-shard-00-02.nfihdq0.mongodb.net:27017";
    String database = "myFirstDatabase";


    // String connectionURL = "mongodb://" + encodedUsername + ":" + encodedPassword + "@atlascluster.nfihdq0.mongodb.net/?retryWrites=true&w=majority&appName=AtlasCluster";
    ...
    public void init() throws ServletException {
        ...
        try {
            ...
            System.out.println("Error encoding username or password: " + e.getMessage());
            return;
        }
        String connectionURL= "mongodb://" + username + ":" + password + "@" + servers + "/" + database + "?w=majority&retryWrites=true&tls=true&authMechanism=SCRAM-SHA-1";
        ...
        try {
            ...
            // If the listCollectionNames method does not throw an exception, the connection is successful
            message = "Connection successful. " + "Collections: " + String.join(", ", collectionNames.into(new ArrayList<>()));
        } catch (Exception e) {
